...
func (tu *TodoUpdate) SetAuthorID(u uuid.UUID) *TodoUpdate {
	tu.mutation.SetAuthorID(u)
	return tu
}

// SetNillableAuthorID sets the "author_id" field if the given value is not nil.
func (tu *TodoUpdate) SetNillableAuthorID(u *uuid.UUID) *TodoUpdate {
	if u != nil {
		tu.SetAuthorID(*u)
	}
	return tu
...
// SetAuthorID sets the "author_id" field.
func (tuo *TodoUpdateOne) SetAuthorID(u uuid.UUID) *TodoUpdateOne {
	tuo.mutation.SetAuthorID(u)
	return tuo
}

// SetNillableAuthorID sets the "author_id" field if the given value is not nil.
func (tuo *TodoUpdateOne) SetNillableAuthorID(u *uuid.UUID) *TodoUpdateOne {
	if u != nil {
		tuo.SetAuthorID(*u)
	}
	return tuo
